...
export class FormulariComponent implements OnInit {
  ...
  constructor( public servicio: AlumService,
    ...
    this.usuario = new FormGroup({
      ...
      domicili: new FormControl('CJosep', [Validators.required, Validators.minLength(2)]),
      ...
      postal: new FormControl('46066', [Validators.required, Validators.minLength(2)]),
      primer: new FormControl('Semper', [Validators.required, Validators.minLength(2)]),
      procedencia: new FormControl('Val', [Validators.required, Validators.minLength(2)]),
      ...
      tel: new FormControl('123456789', [Validators.required, Validators.minLength(2), ValidacionesComponent.tel]),
