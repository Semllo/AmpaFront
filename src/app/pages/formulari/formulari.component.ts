...
export class FormulariComponent implements OnInit {
  ...
  constructor( public servicio: AlumService,
    ...
    this.usuario = new FormGroup({
      ...
      curspro: new FormControl('BNG', [Validators.required, Validators.minLength(2)]),
      ...
      dni: new FormControl('X9464187D', [Validators.required, Validators.minLength(7), Validators.maxLength(9), ValidacionesComponent.DNI,]),
      dniGerma: new FormControl('', []),
      domicili: new FormControl('Calle', [Validators.required, Validators.minLength(2)]),
      ...
      nacionalitat: new FormControl('España', [Validators.required, Validators.minLength(2)]),
      ...
      postal: new FormControl('46644', [Validators.required, Validators.minLength(2)]),
      primer: new FormControl('Semper', [Validators.required, Validators.minLength(2)]),
      procedencia: new FormControl('IES les folles', [Validators.required, Validators.minLength(2)]),
      provincia: new FormControl('Val', [Validators.required, Validators.minLength(2)]),
